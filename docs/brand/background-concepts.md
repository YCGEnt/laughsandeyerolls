...
Phase 1 uses lightweight CSS gradients and subtle framing to suggest the approved texture direction without introducing bitmap assets before family-selected imagery is available.
